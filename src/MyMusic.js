...
import sound from './assets/music/Unstoppable.mp3';
        ...
        return(
            <div style={styles.myMusicContainer}>
                ...
                <div style={styles.info}>
                    <img style={styles.image} src="https://a10.gaanacdn.com/images/albums/15/1611915/crop_480x480_1611915.jpg" alt=''></img>
                    <div style={styles.subInfo}>
                        
                        <h4 style={{marginBottom:'0.5rem'}}>Unstoppable</h4>
                        <p style={{marginBottom:'0'}}>Sia</p>
